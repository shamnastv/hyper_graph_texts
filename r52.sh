...
python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 4 --dropout .4 --num_mlp_layers 1 --dataset R52
python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 4 --dropout .4 --num_mlp_layers 1 --dataset R52 --lda
python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 4 --dropout .4 --num_mlp_layers 1 --dataset R52 --random_vec
