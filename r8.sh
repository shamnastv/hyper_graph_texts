...
python3 main.py --lr 1e-3 --hidden_dim 200 --num_layers 3 --dropout .5 --num_mlp_layers 1 --dataset R8 --random_vec
python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 3 --dropout .3 --num_mlp_layers 1 --dataset R8 --random_vec
