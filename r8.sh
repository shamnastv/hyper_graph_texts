...
python3 main.py --lr 1e-3 --hidden_dim 100 --num_layers 4 --dropout .4 --num_mlp_layers 2 --dataset R8
python3 main.py --lr 1e-3 --hidden_dim 100 --num_layers 4 --dropout .4 --num_mlp_layers 2 --dataset R8 --lda
python3 main.py --lr 1e-3 --hidden_dim 100 --num_layers 4 --dropout .4 --num_mlp_layers 2 --dataset R8 --random_vec