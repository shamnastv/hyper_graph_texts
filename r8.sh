...
python3 main.py --lr 1e-3 --hidden_dim 200 --num_layers 3 --num_mlp_layers 2 --dataset R8 --seed -1
python3 main.py --lr 1e-3 --hidden_dim 200 --num_layers 4 --num_mlp_layers 1 --dataset R8 --seed -1
