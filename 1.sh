...
#python3 main.py --lr 5e-4 --hidden_dim 300 --num_layers 3 --dropout .4 --num_mlp_layers 1

python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 3 --dropout .4 --num_mlp_layers 1 --dataset R8
