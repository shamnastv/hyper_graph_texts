...
python3 main.py --lr 5e-3 --hidden_dim 200 --num_layers 3 --num_mlp_layers 1 --dataset mr --seed -1 --num_clusters 0
python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 3 --num_mlp_layers 1 --dataset mr --seed -1 --num_clusters 0
