...
python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 2 --dropout .3 --dataset R8 --num_exp 2 --num_clusters 2
python3 main.py --lr 5e-4 --hidden_dim 200 --num_layers 2 --dropout .5 --dataset R8 --num_exp 2 --num_clusters 2