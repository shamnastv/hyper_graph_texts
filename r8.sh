...
python3 main.py --lr 1e-3 --hidden_dim 200 --num_layers 3 --dropout .5 --dataset R8 --num_exp 2 --num_clusters 0
python3 main.py --lr 1e-3 --hidden_dim 200 --num_layers 3 --dropout .5 --dataset R8 --num_exp 2 --num_clusters 1
