...
python3 main.py --dataset R8 --num_exp 2 --num_clusters 0 --random_vec
python3 main.py --dataset R8 --num_exp 2 --num_clusters 1 --random_vec
python3 main.py --dataset R8 --num_exp 2 --num_clusters 2 --random_vec
