...
python3 main.py --lr 1e-3 --hidden_dim 200 --num_layers 5 --dropout .4 --num_mlp_layers 1 --dataset R8 --early_stop 20
python3 main.py --lr 1e-3 --hidden_dim 200 --num_layers 5 --dropout .4 --num_mlp_layers 2 --dataset R8 --early_stop 20
