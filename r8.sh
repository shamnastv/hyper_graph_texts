...
python3 main.py --dataset R8 --num_exp 2 --num_clusters 0
python3 main.py --dataset R8 --num_exp 2 --num_clusters 1
python3 main.py --dataset R8 --num_exp 2 --num_clusters 2
