...
python3 main.py --lr 5e-4 --num_layers 3 --dataset R8 --num_exp 2 --num_clusters 0
python3 main.py --lr 5e-4 --num_layers 3 --dataset R8 --num_exp 2 --num_clusters 1
python3 main.py --lr 5e-4 --num_layers 3 --dataset R8 --num_exp 2 --num_clusters 2
