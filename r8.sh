...
python3 main.py --num_layers 3 --dataset R8 --seed -1 --num_clusters 2 --num_exp 2 --early_stop 10 --hidden_dim 50
python3 main.py --num_layers 3 --dataset R8 --seed -1 --num_clusters 2 --num_exp 2 --early_stop 10 --hidden_dim 100
python3 main.py --num_layers 3 --dataset R8 --seed -1 --num_clusters 2 --num_exp 2 --early_stop 10 --hidden_dim 300
