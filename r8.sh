...
python3 main.py --lr 2e-3 --hidden_dim 200 --num_layers 3 --dropout .3 --dataset R8 --num_exp 2 --num_clusters 2
python3 main.py --lr 2e-3 --hidden_dim 200 --num_layers 3 --dropout .5 --dataset R8 --num_exp 2 --num_clusters 2